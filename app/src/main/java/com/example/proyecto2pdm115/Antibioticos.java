...
public class Antibioticos extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antibioticos);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               new AlertDialog.Builder(Antibioticos.this)
                   ...
                   public void onClick(DialogInterface dialog, int which) {
                       ...
                       Intent i = new Intent(Antibioticos.this, Carrito.class);
        ...
        findViewById(R.id.imageButton3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Antibioticos.this.startActivity(new Intent(Antibioticos.this, categorias.class));
            }
        });
